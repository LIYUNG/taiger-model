...
export interface IUserAcademicBackgroundUniversity {
  ...
  Highest_GPA_Uni?: number | null;
  Passing_GPA_Uni?: number | null;
  My_GPA_Uni?: number | null;
  ...
  highestSecondDegreeGPA?: number | null;
  passingSecondDegreeGPA?: number | null;
  mySecondDegreeGPA?: number | null;
