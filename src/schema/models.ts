...
export const UserAcademicBackgroundLanguageSchema = z.object({
  ...
  gre_subject: z.string().optional(),
  gre_score_verbal: z.string().optional(),
  gre_score_quantitative: z.string().optional(),
  gre_score_analytical_writing: z.string().optional(),
  ...
  gmat_score_verbal: z.string().optional(),
  gmat_score_quantitative: z.string().optional(),
  gmat_score_data_insights: z.string().optional(),
  gmat_score_integrated_reasoning: z.string().optional(),
  gmat_score_analytical_writing: z.string().optional(),
